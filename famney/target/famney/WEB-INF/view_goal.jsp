...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .goal-info h3 { color: #2c3e50; font-size: 1.5rem; margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px solid #e9ecef; }

        .goal-detail { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-bottom: 2rem; }
        ...
        .detail-item p { color: #2c3e50; font-size: 1.5rem; font-weight: 600; }
        ...
        @media (max-width: 768px) {
            .content-box { margin: 1rem; padding: 2rem; }
            .nav-menu { gap: 1rem; }
    ...
    <div class="content-box">
        ...
        <div class="goal-info">
            <div class="goal-detail">
                ...
                <div class="detail-item">
                    <h4>Due Date</h4>
                    <p><%= g.getTargetDate() != null ? g.getTargetDate().toString() : "N/A" %></p>
                </div>
                <div class="detail-item">
                    <h4>Created By</h4>
                    <p><%= g.getCreatedBy() %></p>
        ...
        <div class="goal-info" style="text-align: center;">
            ...
            <p>You have not created any savings goals yet.</p>
        </div>
        <% } %>
    </div>
</div>
