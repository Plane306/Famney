<%@ page import="model.User,model.Family" %>
...
<div class="main-container">
    <div class="content-box">
        <div class="content-header">
            ...
            <p>Set a new target to track your family's savings.</p>
        </div>

        <form method="post" action="savings_goals.jsp">
        ...
        <a href="savings_goals.jsp" class="btn-secondary">← Back to Goals</a>
    </div>
</div>
