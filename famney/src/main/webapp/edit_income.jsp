...
<%
    ...
    if (incomeId != null && incomeManager != null) {
        exp = incomeManager.getIncomeById(incomeId);
    }
    if (exp == null) {
%>
    <p>Income not found.</p>
    <a href="incomes.jsp" class="btn-primary">Back to Incomes</a>
<%
        return;
    }
...
<html>
<head>
    <title>Edit Income - Famney</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="main-container">
        <div class="content-box">
            <div class="content-header">
                <h1>Edit Income</h1>
                <p>Update your income details</p>
            </div>
            <form action="IncomeServlet" method="post" class="income-form">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="incomeDate" name="incomeDate" required value="<%= new SimpleDateFormat("yyyy-MM-dd").format(exp.getIncomeDate()) %>" />
                </div>
            ...
            <div style="text-align:center; margin-top:2rem;">
                <a href="incomes.jsp" class="btn-secondary">Back to Incomes</a>
            </div>
        </div>
    </div>
    <footer class="footer">
